...
import { RegistrationDemo } from "./blocks/agent/registration-demo"
...
const components = [
  ...
  },
  {
    name: "scroll-more",
    title: "scroll more",
    description: "scroll indicator with gradient fades and clickable badge.",
    href: "/blocks/scroll-more",
    icon: ChevronsDown,
  },
]
        ...
        <section id="live-demo" className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              an agent that helps users navigate a complex government form. client tools read and write React state directly.
            </p>
          </div>
          <RegistrationDemo proxyUrl="/api/inference/proxy" />
        </section>
